...
public class DeveloperController {
    ...
    public void init(){
        ...
        this.developers.put(1,new SeniorDeveloper(1,"elif",1000d));
    }
    @PostMapping
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
        ...
        return new DeveloperResponse(createdDeveloper,HttpStatus.CREATED.value(), "create işlemi gerçekleştirildi.");
    }
    @GetMapping
    ...
    public DeveloperResponse getById(@PathVariable("id") int id){
        ...
        if(foundDeveloper== null){
            return new DeveloperResponse(null, HttpStatus.NOT_FOUND.value(),id+"ile search kayıt bulunamadı");
        }
        return new DeveloperResponse(foundDeveloper,HttpStatus.OK.value(),"id ile search basarılı");
    }
    ...
    public DeveloperResponse update(@PathVariable("id") int id, @RequestBody Developer developer){
        ...
        return new DeveloperResponse(newDeveloper,HttpStatus.OK.value(), "update basarılı");
    }
    ...
    public DeveloperResponse delete(@PathVariable("id")int id){
        ...
        return new DeveloperResponse(removedDeveloper,HttpStatus.NO_CONTENT.value(), "delete basarılı");
    }
}
